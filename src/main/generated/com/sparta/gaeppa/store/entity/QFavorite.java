...
public class QFavorite extends EntityPathBase<Favorite> {
    ...
    private static final long serialVersionUID = -1840516856L;
    ...
    public final com.sparta.gaeppa.profile.entity.QProfile profile;
    ...
    public QFavorite(Class<? extends Favorite> type, PathMetadata metadata, PathInits inits) {
        ...
        this.profile = inits.isInitialized("profile") ? new com.sparta.gaeppa.profile.entity.QProfile(forProperty("profile"), inits.get("profile")) : null;
