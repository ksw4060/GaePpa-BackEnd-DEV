...
public class QReviewImage extends EntityPathBase<ReviewImage> {
    ...
    private static final long serialVersionUID = -1333157059L;
    ...
    public final com.sparta.gaeppa.review.entity.QReview review;
    ...
    public QReviewImage(Class<? extends ReviewImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.review = inits.isInitialized("review") ? new com.sparta.gaeppa.review.entity.QReview(forProperty("review"), inits.get("review")) : null;
    }
